...
class MatematikPdf extends StatefulWidget {
  const MatematikPdf({Key? key}) : super(key: key);

  @override
  State<MatematikPdf> createState() => _MatematikPdfState();
}

class _MatematikPdfState extends State<MatematikPdf> {
  ...
  void initState() {
    super.initState();
    pdfControllerPinch = PdfControllerPinch(document: PdfDocument.openAsset('assets/integral.pdf'));
  }
