...
class VideoInfo4 extends StatefulWidget {
  const VideoInfo4({Key? key}) : super(key: key);

  @override
  State<VideoInfo4> createState() => _VideoInfo4State();
}

class _VideoInfo4State extends State<VideoInfo4> {
  ...
  Future<void> _initData() async {
    try {
      String data = await DefaultAssetBundle.of(context).loadString("assets/json/videoinfo4.json");
